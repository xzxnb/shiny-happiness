...
class DiscreteDenoisingDiffusion(pl.LightningModule):
    def __init__(self, cfg, dataset_infos, train_metrics, sampling_metrics, visualization_tools, extra_features,
        ...
        if self.generated_smiles_path.exists():
            input('Generated smiles file already exists. Press enter to continue and overwrite it.')
    ...
    def validation_epoch_end(self, outs) -> None:
        ...
        if True or self.val_counter % self.cfg.general.sample_every_val == 0:
            ...
            perc_generated = len(self.dataset_info.val_smiles_set & self.generated_smiles) / len(self.dataset_info.val_smiles_set )
