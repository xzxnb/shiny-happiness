...
from dgd.diffusion.noise_schedule import (
...
class DiscreteDenoisingDiffusion(pl.LightningModule):
    ...
    def compute_Lt(self, X, E, y, pred, noisy_data, node_mask, test):
        ...
        kl_y = (
            (self.test_y_kl if test else self.val_y_kl)(
                prob_true.y, torch.log(prob_pred.y)
            )
    ...
    def compute_val_loss(self, pred, noisy_data, X, E, y, node_mask, test=False):
        ...
        loss_term_0 = (
            self.val_X_logp(X * prob0.X.log())
            + self.val_E_logp(E * prob0.E.log())
    ...
    def sample_batch(
        ...
        for s_int in reversed(range(0, self.T)):
            ...
            # Sample z_s
            sampled_s, discrete_sampled_s, predicted_graph = self.sample_p_zs_given_zt(
                t_norm, X, E, y, node_mask, last_step=s_int == 100
            )
    ...
    def sample_p_zs_given_zt(self, t, X_t, E_t, y_t, node_mask, last_step: bool):
        ...
        if last_step:
            predicted_graph = diffusion_utils.sample_discrete_features(
